...
def calculateMetrics(architecture):
    ...
    return [db_type_utilization, shared_db_interactions, service_interaction_with_inter_comp, asynchronous_service_utilization, directly_shared_services, trans_shared_services, cyclic_dependencies_detection]
